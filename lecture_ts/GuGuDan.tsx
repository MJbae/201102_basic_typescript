...
const GuGuDan = () => {
  ...
  // state 및 useRef 정의 
  const [FirstRandomNumber, setFirstRandomNumber] = useState(Math.ceil(Math.random() * 9))
  const [SecondRandomNumber, setSecondRandomNumber] = useState(Math.ceil(Math.random() * 9))
  const [AnswerNumber, setAnswerNumber] = useState(FirstRandomNumber * SecondRandomNumber)
